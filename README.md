...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/DB-H2%20in--memory-1F6FEB" alt="H2">
...
- 🛠️ **Administradores** gestionan restaurantes, platos, reseñas y usuarios desde el propio panel.
...
- **Spring Data JPA** sobre **H2** en memoria
...
- **Datos de demo** cargados al arrancar (`DataInitializer`).

---

## ▶️ Cómo arrancarlo en local

> Requisitos: **JDK 25**. No necesitas instalar Maven, el proyecto incluye el *wrapper*.
...
- JDBC URL: `jdbc:h2:mem:restaurantes_db`
- Usuario: `sa` · Contraseña: *(vacía)*

> ℹ️ La base de datos es **en memoria**: los datos se reinician en cada arranque y se vuelven a cargar los datos de demo.
...
|--------|:--------:|:-------:|:-----:|
| Ver restaurantes, platos y reseñas | ✅ | ✅ | ✅ |
| Escribir reseñas | ❌ | ✅ | ✅ |
| Crear y gestionar pedidos | ❌ | ✅ | ✅ |
| Marcar favoritos | ❌ | ✅ | ✅ |
| Crear/editar/desactivar restaurantes y platos | ❌ | ❌ | ✅ |
| Moderar reseñas y gestionar usuarios | ❌ | ❌ | ✅ |
...
├── config/        # Seguridad, recursos web y carga de datos demo
...
- Persistencia con base de datos real (PostgreSQL/MySQL) y migraciones.
